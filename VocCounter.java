 ...
 */
public class VocCounter {
    private Set<String> initialTerms, embeddings;
    private String embeddingsFile, outputRepository, collectionRepository;

    public String model = "";

    public VocCounter(String collectionRepository, String embeddingsFile, String outputRepository) {
    ...
    public void writeMassiveFile() {
        ...
        try {
            ...
            pw = new PrintWriter(outputRepository + "/words_model.txt");
    ...
    public static void run1() {
        VocCounter oovh = new VocCounter("C:\\Users\\georg\\Desktop\\IR_Project_2020\\CollectionTxt",
                "/media/DataHD/users/tzk/Documents/MOSCHOVIS/Embeddings/Example/modelbasic_phr_mcnt6.vec",
                "C:\\Users\\georg\\Desktop\\IR_Project_2020\\Vocabulary");
        oovh.PopulateCollectionData();
        oovh.writeMassiveFile();
    }

    public static void main(String[] args) { run1(); }
}
