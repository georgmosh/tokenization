...
public class Preprocessor_2 {
    ...
    public Preprocessor_2() {
        ...
        data = new ArrayList<Vec2<String, String>>();
        this.GenerateSearchData();
        this.WriteTextFile();
    }

    public static void main(String[] args) { new Preprocessor_2(); }
...
//        data = " /// \n";
    ...
    public void ReadTargetFile(String filePath) {
        ...
        try {
            ...
            data.add(currentDoc); //currentDoc.getTValue() + "\n" + currentDoc.getYValue() + "\n /// \n";
    ...
    public void WriteTextFile() {
        try {
            for(int i = 0; i < data.size(); i++) {
                String name = data.get(i).getTValue();
                String content = data.get(i).getYValue();
                PrintWriter pw = new PrintWriter(outputDataRepository + "\\" + name + ".txt");
                pw.write(content); pw.flush(); pw.close();
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
